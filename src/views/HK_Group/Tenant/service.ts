...
class TenantService {
    ...
    public async create(input: SalePointDto | undefined) {
        ...
        try {
            ...
            input?.nameContact && params.append('nameContact', input.nameContact.toString());
            input?.phone && params.append('phone', input.phone.toString());
            input?.description && params.append('description', input.description.toString());
    ...
    public async search(input: FilterParams): Promise<PagedResultDto<SalePointOutDto>> {
